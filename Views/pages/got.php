<?php
    ...
    $getList = $pages->getAllListGot();
    $numPrev = $pages->getBtnPrevGot();
    $numNext = $pages->getBtnNextGot();
    $numPage = $pages->getNumPageGot();
    
?>

<div class="content m-auto">
    <div class="content_productsNew">
        <h4><a href="index.php">TRANG CHỦ</a> > GIÀY CAO GÓT</h4><hr class="mt-0">
