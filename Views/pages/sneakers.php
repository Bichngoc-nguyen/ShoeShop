<?php
    ...
    $getList = $pages->getAllListSneakers();
    $numPrev = $pages->getBtnPrev();
    $numNext = $pages->getBtnNext();
    $numPage = $pages->getNumPage();
    
?>

<div class="content m-auto">
    <div class="content_productsNew">
        <h4><a href="index.php">TRANG CHỦ</a> > GIÀY SNEAKERS</h4><hr class="mt-0">
